	...
	jPlayerPlaylist.prototype = {
		...
		_createListItem: function(a) {
			...
			d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'><span class='jp-playpause'><em class='fa fa-play'></em><em class='fa fa-pause'></em></span><span class='title-song'>" + a.title + (a.artist ?
				...
				if (a.downloadurl || a.amzstore || a.appstore || a.soundcloud || a.grvstore) {
				d += "<span class='jp-social-option'>";
				if (a.url) {
						d += "<a class='jp-downloadurl' href='"+a.url+"'><em class='fa fa-shopping-cart'></em></a>";
				}
				if (a.soundcloud) {
					d += "<a class='jp-soundcloud'  href='"+a.soundcloud+"'><em class='fa fa-soundcloud'></em></a>";
				}
				if (a.grvstore) {
					d += "<a class='jp-grvstore'  href='"+a.grvstore+"'><em class='fa fa-groove-store'></em></a>";
				}
				if (a.appstore) {
					d += "<a class='jp-appstore'  href='"+a.appstore+"'><em class='fa fa-app-strore'></em></a>";
				}
				if (a.amzstore) {
					d += "<a class='jp-amzstore'  href='"+a.amzstore+"'><em class='fa-amazan-strore'></em></a>";
				}
				d += "</span>";
				}
				if(a.jptime){
